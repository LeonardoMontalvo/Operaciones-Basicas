...
public class ComprobacionNumerica extends javax.swing.JFrame {
 ...
 int num = Integer.parseInt(txtNumero.getText());
    ...
    if (Divisores == num) {
        JOptionPane.showMessageDialog(rootPane, "El número " + num + " es perfecto");
    } else {
        JOptionPane.showMessageDialog(rootPane, "El número " + num + " no es perfecto");
    }
